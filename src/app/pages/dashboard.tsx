  ...
  return (
    <div className="min-h-screen bg-[#f9fafb]">
        ...
        <div className="max-w-7xl mx-auto px-10 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-8">
              <button onClick={() => navigate('/dashboard')} className="text-[#101828] text-[16px] font-semibold pb-2 border-b-2 border-[#101828]">
                Dashboard
              </button>
              <button onClick={() => navigate('/dashboard')} className="text-[#4a5565] text-[16px] font-medium pb-2 border-b-2 border-transparent hover:text-[#101828]">
                Charging
              </button>
              <button onClick={() => navigate('/dashboard')} className="text-[#4a5565] text-[16px] font-medium pb-2 border-b-2 border-transparent hover:text-[#101828]">
                Incentives
      ...
      <div className="max-w-[600px] mx-auto px-6 py-8">
        ...
        {/* Charge History */}
        <div className="mb-6">
          <h2 className="text-[#101828] text-[20px] font-bold mb-4">Charge history</h2>
          <div className="bg-white rounded-lg p-12 text-center">
            <p className="text-[#6a7282] text-[16px] mb-1">No charge history yet</p>
            <p className="text-[#99a1af] text-[14px]">Your charging sessions will appear here</p>
          </div>
        </div>
      </div>
    </div>
