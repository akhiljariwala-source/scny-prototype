  ...
  return (
    <div className="min-h-screen bg-[#f9fafb]">
        ...
        <div className="max-w-7xl mx-auto px-10 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-8">
              <button onClick={() => navigate('/dashboard-verification-progress')} className="text-[#101828] text-[16px] font-semibold pb-2 border-b-2 border-[#101828]">
                Dashboard
              </button>
              <button onClick={() => navigate('/dashboard-verification-progress')} className="text-[#4a5565] text-[16px] font-medium pb-2 border-b-2 border-transparent hover:text-[#101828]">
                Charging
              </button>
              <button onClick={() => navigate('/dashboard-verification-progress')} className="text-[#4a5565] text-[16px] font-medium pb-2 border-b-2 border-transparent hover:text-[#101828]">
                Incentives
      ...
      <div className="max-w-[600px] mx-auto px-6 py-8">
        ...
        <div className="bg-[#f1fafd] border border-[#bee7f5] rounded-[14px] p-5 mb-6 flex items-start justify-between">
          <div>
            <h3 className="text-black text-[16px] font-bold mb-2">Verification in progress</h3>
            <p className="text-black text-[16px] leading-relaxed">
              Account verification is in progress. You can receive<br />
              incentive payouts once your account has been verified.
            </p>
          </div>
          <button 
