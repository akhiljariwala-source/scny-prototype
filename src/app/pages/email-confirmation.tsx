  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-[1100px] mx-auto px-6 py-4">
        ...
        <div className="mb-2">
          <h1 className="text-[#202124] text-[20px] font-bold mb-0.5">Please verify your account</h1>
        ...
        <div className="flex items-start justify-between mb-1">
          ...
          <span className="text-[#5f6368] text-[13px] whitespace-nowrap">9 February 2026 at 15:43</span>
        </div>
        ...
        <div className="flex justify-center py-8 bg-[#f2f2f2]">
          <div className="w-full max-w-[640px] rounded-lg overflow-hidden">
            ...
            <div className="bg-white px-8 py-8">
              <h2 className="text-[#202124] text-[22px] font-bold text-center mb-8">Verify your account</h2>

              <p className="text-[#364153] text-[15px] mb-5">Hi there,</p>

              <p className="text-[#364153] text-[15px] leading-[1.7] mb-5">
                We need some more information to verify your account and fully enroll you in the SmartCharge New York program. Once you are verified you will gain full access to the program charging benefits and features.
              </p>

              <p className="text-[#364153] text-[15px] leading-[1.7] mb-5">
                Please login and enter the additional information when prompted.
              </p>

              <p className="text-[#101828] text-[15px] leading-[1.7] font-semibold mb-8">
                Please note: until you are verified you are able to earn, but not receive, incentives.
              </p>
            ...
            <div className="bg-white px-8 pb-8 pt-4 border-t border-[#e5e7eb]">
              <div className="text-center">
                ...
                <p className="text-[#5f6368] text-[11px] leading-relaxed mb-4">
                  Copyright © 2026 ev.energy. All rights reserved. ev.energy Corp, <span className="underline">2100 Geng Road, Suite 210</span><br />
                  <span className="underline">Palo Alto, California, 94303, United States of America</span>, Impressum
                </p>
